...
\begin{figure}
	...
	\caption{(Left) Mean velocity profile (Van Driest transformed) in the wall normal direction ($+$ units) for the coarse (dashed), medium (dashed-dot) and fine (solid) mesh cases at the nozzle throat.  (Right) Diagonal components of the Reynolds stress for the three cases.
	\label{fig:BL_prof}
	}
\end{figure}
