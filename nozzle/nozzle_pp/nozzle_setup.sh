...
ifort papam_nozzle.f90 -o papam
./papam 0
...
TARFILE=nozdep_$(date +%Y.%m.%d_%H.%M.%S).tgz
mkdir nozzle_dep
cp nozzle.grid nozzle_init.tec nozzle.inflow papam_nozzle.f90 nozzle_dep
mv nozzle_dep/nozzle_init.tec nozzle_dep/nozzle.init
tar cvzf $TARFILE nozzle_dep
rm -rf nozzle_dep
