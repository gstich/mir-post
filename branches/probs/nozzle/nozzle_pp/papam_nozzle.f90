...
INTEGER, PARAMETER :: seg7=100
INTEGER, PARAMETER :: seg=seg1+seg2+seg3+seg4+seg5+seg6+seg7

!  Specify Units in [mm]
DOUBLE PRECISION , PARAMETER :: throat = 22.5d0            ! Throat height
DOUBLE PRECISION , PARAMETER :: Aratio = 1.4               ! Area-ratio of the nozzle
DOUBLE PRECISION , PARAMETER :: NPR = 1.77d0                ! Nozzle Pressure Ratio (P_res/P_a) [1.2,1.8]
...
DOUBLE PRECISION , PARAMETER :: inlet_x = 152.4d0          ! X-location of inlet (relative-up from noz_x)
DOUBLE PRECISION , PARAMETER :: inlet_y = 50.8d0           ! Y-location of inlet (relative-left from noz_y)

!  Segment parameters - Outer Boundaries
LOGICAL                      :: full = .TRUE.              ! Make full nozzle or half
DOUBLE PRECISION , PARAMETER :: R3 = 0.5d0*noz_y            ! Radius of turn for segment #3
DOUBLE PRECISION , PARAMETER :: R5=2.0d1*Aratio*two*noz_y  ! Radius of background mesh

!  Grid Parameters
INTEGER , PARAMETER          :: nx = 1024             ! Number of points in /xi direction
INTEGER , PARAMETER          :: ny = 256              ! Number of points in /eta direction
DOUBLE PRECISION , PARAMETER :: wall  = 0.2d0        ! Zoom factor at wall in uniform spacing
DOUBLE PRECISION , PARAMETER :: wall2 = .2d0 !0.03d0        ! Thickness of refined region near wall
DOUBLE PRECISION , PARAMETER :: wall3 = 10.0d0              ! Width of interface from fine to course in grid points
DOUBLE PRECISION , PARAMETER :: core  = 0.3d0               ! Zoom factor of the plume in uniform spacing units
...
DOUBLE PRECISION , PARAMETER :: loci = dble(nx)*.86d0  ! Location in grid number of stretch-> iso interface
